import { Page } from '@playwright/test'; // Importation du type Page
...
export async function checkAndClosePopup(page: Page) {
    const consentButton = page.locator('role=button[name="Consent"]');
